...
ActiveRecord::Schema[8.0].define(version: 2025_01_29_094912) do
  ...
  create_table "etablissements", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "dernierNumeroVoieEtablissement"
    t.string "indiceRepetitionDernierNumeroVoieEtablissement"
    t.string "identifiantAdresseEtablissement"
    t.string "coordonneeLambertAbscisseEtablissement"
    t.string "coordonneeLambertOrdonneeEtablissement"
    t.index ["siret"], name: "index_etablissements_on_siret", unique: true
    t.index ["unite_legale_id"], name: "index_etablissements_on_unite_legale_id"
  end
  ...
  create_table "unite_legales", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
